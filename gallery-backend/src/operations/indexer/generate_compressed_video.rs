...
use crate::{
    jobs::indexer::image_info::process_image_info, operations::indexer::generate_ffmpeg::create_silent_ffmpeg_command, public::{structure::database_struct::database::definition::Database, tui::DASHBOARD}
};
use anyhow::Context;
use regex::Regex;
use std::{
